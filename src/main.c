...
void generate_legal_output(int* pi_digits, int num_digits) {
    printf("//AUTOGENERATED_LEGAL_DATA_BEGIN\n");
    printf("Claimant: Nnamdi Michael Okpala, OBINexus Founder\n");
    printf("Respondent: Thurrock Council\n");
    printf("Total_Base_Violations: %d\n", BASE_VIOLATIONS);
    printf("Violation_Cycles_Per_Year: %.1f\n", VIOLATION_CYCLES_PER_YEAR);
    ...
    printf("Matrix_Determinant: %.2f\n", det);
    printf("Infinity_Classification: U∞\n");
    printf("Remedy_Sought: £10,000 per violation cycle\n");
    printf("Housing_Units_Requested: 15\n");
    printf("Land_Requested: 25 acres\n");
    printf("//AUTOGENERATED_LEGAL_DATA_END\n");
}

void generate_design_output(int* pi_digits, int num_digits) {
